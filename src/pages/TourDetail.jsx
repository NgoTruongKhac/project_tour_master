            ...
            {departure && (
              <div className="p-6 border shadow-sm bg-gray-50 border-primary rounded-2xl">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="flex items-center gap-3 p-3 bg-white border rounded-lg border-primary">
              ...
              {tour.itineraries.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="p-5 pt-0 text-justify text-gray-900 border-t border-gray-100 border-dashed bg-gray-50/50">
