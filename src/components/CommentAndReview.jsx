import React, { useState, useEffect, useMemo } from 'react'; // 1. Thêm import useEffect, useMemo
...
const CommentAndReview = ({ currentTourId = 1 }) => {
    ...
    const summaryData = useMemo(() => {
        ...
        if (jsonData.summary) return jsonData.summary;
                        ...
                        <div className="flex items-center bg-gray-50 px-6 py-3 rounded-lg border border-gray-100 w-full md:w-auto">
                            ...
                            <div className="pl-6">
                                ...
                                <p className="text-sm text-gray-500">
                                    Dựa trên <strong>{reviews.length}</strong> đánh giá
                                </p>
                            </div>
                        </div>
